  ...
  const phases = [
    {
      ...
      title: "The Factory",
      status: "LIVE",
      description: "Unmetered environment generation to global edge. Zero configuration required. Operational in under sixty seconds.",
      icon: (
    ...
    },
    {
      ...
      description: "Hardware-isolated micro-virtual machines for data-sensitive enterprise. Absolute physical separation. No shared infrastructure.",
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      title: "The Standard",
      status: "DEPLOYING",
      description: "Proprietary development kits standardize identity and commerce across ecosystem. One architectural standard. Every environment.",
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Fully autonomous organizational engine. Abstract intent converted to operational reality without human in execution chain.",
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section className="w-full max-w-6xl mx-auto flex flex-col gap-6 md:gap-8 py-16 md:py-20 lg:py-24 px-4 md:px-6">
      <div className="flex flex-col md:flex-row justify-between items-end border-b border-[#1C1E26] pb-4">
        <div className="flex flex-col gap-2">
          <h4 className="text-[#C8D8F0] text-xs font-bold tracking-[0.2em] uppercase" style={{ fontFamily: "var(--font-geist-mono), monospace" }}>The Deployment Sequence</h4>
