...
const faqs = [
  ...
  },
  {
    ...
    answer: 'We utilize a Global Edge Network architecture. Unlike traditional servers that hit capacity limits, Rivtor deployments automatically replicate across global availability zones, ensuring enterprise-grade uptime from Day 1.'
  },
  {
    question: 'Is this platform compliant for the EU market?',
    answer: 'Explicitly. Rivtor was architected with a "Europe-First" compliance mindset. Our infrastructure defaults to EU data residency, and our Kernel includes automated workflows for GDPR "Right to be Forgotten" and ePrivacy Directive mandates.'
  },
  {
