      ...
      <div className="container relative z-20">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              Code generation is a commodity. Operational Sovereignty is the asset. Rivtor architects, deploys, and governs scalable software companies without human intervention.
            </motion.p>
              ...
              <div className="relative bg-gradient-to-br from-[#1A1A1A] to-[#0A0A0A] rounded-lg border border-gray-800 p-8 shadow-2xl">
                ...
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="font-mono text-sm text-gray-300">Rivtor Dashboard</div>
                  </div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-700">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="font-mono text-xs text-gray-400">© 2026 Rivtor.</div>
                  </div>
                </div>
              </div>
